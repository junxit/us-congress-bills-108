...
- **(1)** by striking paragraph (1) and inserting the following:
  > - **(b)**
  >   - **(1)** No cable system or other multichannel video programming distributor shall retransmit the signal of a broadcasting station, or any part thereof, except with the express authority of the station.
...
- **(2)** in paragraph (3)—
  ...
  - **(C)** by adding at the end the following:
    > - **(C)** Within 45 days after the effective date of the &short-title1;, the Commission shall commence a rulemaking proceeding to revise the regulations governing the exercise by television broadcast stations of the right to grant retransmission consent under this subsection. Such regulations shall establish election time periods that correspond with those regulations adopted under subparagraph (B). The rulemaking shall be completed within 180 days after the effective date of the &short-title1;.

- **(3)** by striking paragraphs (4) and (5) and redesignating paragraph (6) as paragraph (4).

## § 3. Elimination of must-carry requirements
...
## § 4. Termination of mandates for television features and functions
