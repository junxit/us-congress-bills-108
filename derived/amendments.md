...
|---|---|---|---|
| `26 U.S.C. § 145` | add-at-end | Section 145 of the Internal Revenue Code of 1986 (relating to qualified 501(c)(3) bonds) is amended by adding at the end the following new subsection: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
