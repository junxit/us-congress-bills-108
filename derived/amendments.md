...
|---|---|---|---|
| `26 U.S.C. § 9711` | add-at-end | Section 9711(g) of the Internal Revenue Code of 1986 (relating to rules applicable to this part and part II) is amended by adding at the end the following: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
