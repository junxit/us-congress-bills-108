...
# What H.Res. 685 would do to existing law
...
|---|---|---|---|
| — | insert | In section 211 (relating to reconciliation in the House of Representatives), by inserting at the end the following new subsection: | the bill names no machine-readable US Code section |
