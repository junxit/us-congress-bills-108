...
|---|---|---|---|
| `5 U.S.C. § 5315` | add-at-end | Section 5315 of title 5, United States Code, relating to level IV of the Executive Schedule, is amended by adding at the end of the list in such section the following new item: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
