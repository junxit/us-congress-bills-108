...
# What S.Res. 428 would do to existing law
...
|---|---|---|---|
| — | replace | Senate Resolution 356, 102d Congress, agreed to October 7, 1992, is amended by striking section 5 and inserting the following: | the bill names no machine-readable US Code section |
