...
|---|---|---|---|
| `49 U.S.C. § 5307` | add-at-end | Section 5307(b)(1) of title 49, United States Code, is amended by adding at the end the following: “The Secretary may make grants under this section to a transit system to finance the operating cost of equipment and facilities for use in… | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
