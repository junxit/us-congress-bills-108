...
|---|---|---|---|
| `26 U.S.C. § 4462` | redesignate | Section 4462 of the Internal Revenue Code of 1986 (relating to definitions and special rules) is amended by redesignating subsection (i) as subsection (j) and by inserting after subsection (h) the following new subsection: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
