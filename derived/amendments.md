...
|---|---|---|---|
| — | add-at-end | Subchapter I of chapter 2205 of title 36, United States Code, is amended by adding at the end the following new section: | the bill names no machine-readable US Code section |
| — | redesignate | by redesignating paragraphs (6) through (8) as paragraphs (7) through (9) respectively; and | the bill names no machine-readable US Code section |
