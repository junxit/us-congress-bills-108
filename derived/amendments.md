...
|---|---|---|---|
| — | amend | Section 201(c) of the National Oceanic and Atmospheric Administration Authorization Act of 1992 is amended to read as follows: | the bill names no machine-readable US Code section |
