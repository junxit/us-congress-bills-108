...
|---|---|---|---|
| `26 U.S.C. § 263A` | add-at-end | Section 263A(f) of the Internal Revenue Code of 1986 (relating to general exceptions) is amended by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
