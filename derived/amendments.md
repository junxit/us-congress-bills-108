...
# What H.R. 4587 would do to existing law
...
|---|---|---|---|
| — | add-at-end | Part II of subtitle A of title 10, United States Code, is amended by adding at the end the following new chapter: | the bill names no machine-readable US Code section |
