...
|---|---|---|---|
| — | replace | Subchapter II of chapter 99 of the Harmonized Tariff Schedule of the United States is amended by striking heading 9902.32.86 and inserting the following: | the bill names no machine-readable US Code section |
